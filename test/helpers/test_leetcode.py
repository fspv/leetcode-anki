...
import leetcode.models.graphql_data
import leetcode.models.graphql_question_contributor
import leetcode.models.graphql_question_detail
import leetcode.models.graphql_question_solution
import leetcode.models.graphql_question_topic_tag
import leetcode.models.graphql_response
import leetcode.models.problems
import leetcode.models.stat
...
class TestLeetcodeData:
    _question_detail_singleton: leetcode.models.graphql_question_detail.GraphqlQuestionDetail
    _leetcode_data_singleton: leetcode_anki.helpers.leetcode.LeetcodeData

    @property
    def _question_details(
        self,
    ) -> leetcode.models.graphql_question_detail.GraphqlQuestionDetail:
        return self._question_detail_singleton

    @property
    def _leetcode_data(self) -> leetcode_anki.helpers.leetcode.LeetcodeData:
        return self._leetcode_data_singleton
